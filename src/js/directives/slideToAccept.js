  ...
  .directive('slideToAccept', function($timeout, $window, $q) {
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        function setNewHushStyle(pct) {
          var translatePct = -2.25 * pct;
          scope.HushStyle = getTransformStyle(translatePct);
          curHushPct = pct;
        }
        ...
        function easeSliderPosition(pct) {
          ...
          easePosition(curHushPct, pct, duration, JIGGLE_EASING, function(pct) {
            setNewHushStyle(pct);
          });
        ...
        function jiggleSlider() {
          ...
          var p2 = easePosition(curHushPct, pct, duration, JIGGLE_EASING, function(pct) {
            setNewHushStyle(pct);
          });
        ...
        function recede() {
          ...
          easePosition(curHushPct, 0, duration, easeInOutBack, function(pct) {
            setNewHushStyle(pct);
          });
